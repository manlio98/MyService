...
<%String nomeServizio = (String)request.getSession().getAttribute("nomeServizio"); %>
 ...
 Servizio servizio = modelServizio.getServiziobyNomeServizio(nomeServizio);
 %>
...
<title>Inserimento news</title>
</head>
<body>
<nav class="navbar container-fluid navbar-expand-lg navbar-light bg-light">
<img class="logo" alt="logo" src="../<%=servizio.getUrlLogo()%>">
  <a class="navbar-brand" href="./index-provider.jsp" style="text-transform: capitalize"><%=nomeServizio %></a>
</nav>
<br>
<h1 style="text-align: center;">Inserimento News</h1>

<div class="container" style="border: 1px solid black;  border-radius: 5px;">
<div style="justify-content: center; display: flex;">
<form id="regForm" action="../InserimentoNotizia" method="get">
<!-- One "tab" for each step in the form: -->
<div class="tab">
  <p>Titolo News<input name="titolo" placeholder="Titolo News..." class="form-control" required></p>
  <p>Nome Servizio<input placeholder="Nome Servizio..." class="form-control" value="<%=nomeServizio%>" readonly></p>
  <p>Contenuto News<textarea name="contenuto"class="form-control" placeholder="Contenuto news..." required></textarea></p>
  <p><button type="submit" class="btn btn-warning">Completa Inserimento</button></p>
</div>
</form>
</div>
</div>
