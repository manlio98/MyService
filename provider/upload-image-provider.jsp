...
<%
Boolean b = (Boolean)request.getSession().getAttribute("registerServizio"); /*controllo per non accedere alla pagina direttamente*/
if(b == null || b == false) {
...
<div class="container" style="border: 1px solid black;  border-radius: 5px; display: flex; justify-content: center;">
   <div id='vendi' style='padding-top:10px;'>
              	<form id="regForm1" action="../UploadImageProvider" method="POST"  enctype="multipart/form-data"  style='margin:0 auto;'> <!--Fase di realizzazione-->                  
                    <div class="tab1"> 
                       ...
                       <br><br>
				            ...
				            <br><br>oppure<br><br>
				            <form action="../CompletaRegistrazione" method="post">
				            	<button  type="submit" class="btn btn-warning" style="margin-bottom: 5px;">Registrazione Completata</button>
				            </form>
             </div>
                </form>
