...
<div class="container" style="border: 1px solid black;  border-radius: 5px; display: flex; justify-content: center;">
   <div id='vendi' style='padding-top:10px;'>
              	<form id="regForm1" action="../UploadImageNews" method="POST"  enctype="multipart/form-data"  style='margin:0 auto;'> <!--Fase di realizzazione-->                  
                    <div class="tab1"> 
                    	<img src="../<%=image%>" style="max-width:300px; width:100%;">
                       <br><br>
				            <form action="../UploadImageNews" method="post" enctype="multipart/form-data">
				            ...
				            <br><br>oppure<br><br>
				            <form action="../CompletaInserimentoNews" method="post">
				            	<button  type="submit" class="btn btn-warning" style="margin-bottom: 5px;">Inserisci</button>
				            </form>
             </div>
                </form>
