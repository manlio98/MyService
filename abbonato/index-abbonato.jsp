<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 Collection<Servizio> servizi = modelServizio.getServizibyUserAbbonati(username);
 String usernameAbbonato = abbonato.getUsername();
 
 if (servizi == null || servizi.size()==0) {
 	response.sendRedirect("./index-servizi-non-abbonati.jsp?username="+usernameAbbonato);    
 } 
...
<title>Home Page Abbonato</title>
</head>
<body>
...
<img class="logo" alt="logo" src="../image/logo.PNG">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#servizi">I miei Servizi</a>
      </li>
      <li class="nav-item">
...
<br>
<br>
<h1 id="servizi" style="text-align: center;">I miei Servizi</h1>
	...
	%>
		...
		<div class="col mb-4">
			<div class="card" style="height: 420px!important;">
				<img alt="<%=bean.getNomeServizio()%>" data-src="../<%=bean.getUrlLogo()%>"  onclick="window.open('index-news.jsp?nomeServizio=<%=bean.getNomeServizio()%>','_self')" class="card-img-top owl-lazy" style=" cursor: grab;width: 100px; height: 100px;  display: block; margin-left: auto;margin-right: auto;">
				<div class="card-body">
					<h5 class="card-title" style=" cursor: pointer; text-transform: capitalize" onclick="window.open('index-news.jsp?nomeServizio=<%=bean.getNomeServizio()%>','_self')"><%=bean.getNomeServizio()%></h5>
					<p class="card-text" style=" cursor: pointer;" onclick="window.open('index-news.jsp?nomeServizio=<%=bean.getNomeServizio()%>','_self')"><%=bean.getDescrizione()%></p>
					<div class="end">
					<a href="index-news.jsp?nomeServizio=<%=bean.getNomeServizio()%>">Vai alle news</a>
       				</div>
				</div>
			</div>	
		</div>
